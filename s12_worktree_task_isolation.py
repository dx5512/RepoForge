...
# 2. 彻底转换为 OpenAI 标准的 Function Schema 格式
TOOLS = [
...
# 3. 彻底重写 agent_loop 适配 OpenAI 调用链
def agent_loop(messages: list):
    while True:
        ...
        for tool_call in assistant_msg.tool_calls:
            ...
            print(f"> \033[36m{tool_call.function.name}\033[0m: {str(output)[:200]}")
...
if __name__ == "__main__":
    print(f"\033[90mRepo root for s12: {REPO_ROOT}\033[0m")
    if not WORKTREES.git_available:
        print("\033[33mNote: Not in a git repo. worktree_* tools will return errors.\033[0m")

    # System Prompt 初始化必须位于 messages 首位
